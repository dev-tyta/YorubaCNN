...
CREATE DATABASE `yor_wikipedia_2021_10K`;

USE `yor_wikipedia_2021_10K`;
...
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'yor_wikipedia_2021_10K-sources.txt' INTO TABLE sources;
